...
def get_user_credentials(
    scopes, client_id, client_secret, minimum_port=..., maximum_port=...
) -> (
    google.auth.external_account_authorized_user.Credentials | google.oauth2.credentials.Credentials
):
